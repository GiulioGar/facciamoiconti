...
class AppetibilityCalculatorTest extends TestCase
{
    ...
    // 1. Top consolidato: FVM alto + FM alta + tante presenze → score >70, ranking corretto
    public function test_top_consolidato_scores_high_and_ranked_correctly(): void
    {
        $players = [
            ['external_id' => 1, 'fvm' => 100, 'pv' => 38, 'fm' => 8.50, 'mv' => 7.80, 'like' => 0, 'dislike' => 0],
            ['external_id' => 2, 'fvm' => 50,  'pv' => 38, 'fm' => 5.50, 'mv' => 5.50, 'like' => 0, 'dislike' => 0],
            ['external_id' => 3, 'fvm' => 20,  'pv' => 38, 'fm' => 4.00, 'mv' => 4.00, 'like' => 0, 'dislike' => 0],
        ];

        $scores = $this->calc->computeForRole($players);
    ...
    // 2. Poche presenze: stesso FM eccellente ma Pv=2 → affidabilità bassa → score smorzato
    public function test_low_pv_dampens_excellent_fm(): void
    {
        $players = [
            ['external_id' => 1, 'fvm' => 50, 'pv' => 2,  'fm' => 9.0, 'mv' => 9.0, 'like' => 0, 'dislike' => 0],
            ['external_id' => 2, 'fvm' => 50, 'pv' => 30, 'fm' => 9.0, 'mv' => 9.0, 'like' => 0, 'dislike' => 0],
            ['external_id' => 3, 'fvm' => 50, 'pv' => 30, 'fm' => 4.0, 'mv' => 4.0, 'like' => 0, 'dislike' => 0],
        ];

        $scores = $this->calc->computeForRole($players);

        // Player 1 ha FM=9 come player 2, ma pv=2 → rel=0.1 → B smorzato verso la media
        $this->assertLessThan($scores[2], $scores[1], 'Con Pv=2 il vantaggio FM=9 è smorzato: score < Pv=30 con stesso FM');
    }
    ...
    {
        $players = [
            ['external_id' => 1, 'fvm' => 50, 'pv' => null, 'fm' => null, 'mv' => null, 'like' => 0, 'dislike' => 0],
            ['external_id' => 2, 'fvm' => 50, 'pv' => 20,   'fm' => 8.00, 'mv' => 8.00, 'like' => 0, 'dislike' => 0],
            ['external_id' => 3, 'fvm' => 50, 'pv' => 20,   'fm' => 4.00, 'mv' => 4.00, 'like' => 0, 'dislike' => 0],
        ];
        ...
        // Nessuno storico → B = media ruolo → score tra top (2) e bottom (3)
    ...
    {
        $base = ['fvm' => 50, 'pv' => 20, 'fm' => 5.0, 'mv' => 5.0];
        $players = [
    ...
    {
        $players = [
            ['external_id' => 1, 'fvm' => 9999, 'pv' => 38,   'fm' => 10.0, 'mv' => 10.0, 'like' => 999, 'dislike' => 0],
            ['external_id' => 2, 'fvm' => 1,    'pv' => 1,    'fm' => 1.0,  'mv' => 1.0,  'like' => 0,   'dislike' => 999],
            ['external_id' => 3, 'fvm' => 0,    'pv' => null, 'fm' => null, 'mv' => null, 'like' => 0,   'dislike' => 999],
        ];
